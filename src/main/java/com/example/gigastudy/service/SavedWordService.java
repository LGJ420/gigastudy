        ...
        return savedWords.stream()
                .map(userWord -> UserWordDTO.builder()
                        .wordDTO(WordDTO.builder()
                                ...
                                .similar1(userWord.getWord().getSimilar1())
                                .similar2(userWord.getWord().getSimilar2())
                                .similar3(userWord.getWord().getSimilar3())
                                .similar4(userWord.getWord().getSimilar4())
                                .similar5(userWord.getWord().getSimilar5())
                                .similar6(userWord.getWord().getSimilar6())
                                .similar7(userWord.getWord().getSimilar7())
                                .build())
                        .seq(userWord.getSeq())
                        .build())
